...
{
    static class SobelOperator
    {
        private static readonly ParallelOptions _pOptions = new ParallelOptions { MaxDegreeOfParallelism = 16 };

        public static Bitmap sobelOperator(this Bitmap sourceBitmap, bool grayscale)
        {
            Bitmap resultBitmap = ConvolutionFilter(sourceBitmap, Sobel3x3Horizontal, Sobel3x3Vertical, 1.0, 0, grayscale);
            return resultBitmap;
        }
                                         ...
                                         bool grayscale = false)
        {
            ...
            if (grayscale == true)
            {
                ...
                //Parallel.For(0, pixelBuffer.Length, k =>
